     ...
     def checkStorage(self, conn, min_disk_gb):
            ...
            try:
                ...
                if avail_space > min_disk_gb:
                    ...
                    logger.info(msg)
                    print(msg)
                    return {"status": "OK", "avail_space": avail_space}  # ✅ CHANGED LINE 1
                ...
                if len(files_to_delete) == 0:
                    ...
                    self.disconnect(logger)
                    return {"status": "FAILED", "reason": "cleanup_files empty"}  # ✅ CHANGED LINE 2
                ...
                logger.info(msg)
                print(msg)
                return {"status": "SELECTED_FILES_DELETED", "avail_space": avail_space}  # ✅ CHANGED LINE 3
