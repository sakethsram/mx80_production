...
def parse_show_bfd_session(text_content) -> dict[str, any]:
    ...
    try:
        ...
        return {"error": f"Error parsing show bfd session: {str(e)}"}
def parse_show_rsvp_neighbor(text_content) -> dict[str, any]:
    ...
    try:
        ...
        return {"error": f"Error parsing show rsvp neighbor: {str(e)}"}
def parse_show_rsvp_session(text_content) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"error": f"Error parsing show rsvp session: {str(e)}"}
def parse_show_route_table_inet0(text_content) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"error": f"Error parsing show route table inet.0: {str(e)}"}
def parse_show_route_table_inet3(text_content) -> dict:
    ...
    try:
        ...
        return {"error": f"Error parsing show route table inet.3: {str(e)}"}
def parse_show_route_table_mpls0(text_content) -> dict[str, any]:
    ...
    try:
        ...
        return {"error": f"Error parsing show route table mpls.0: {str(e)}"}
def parse_show_mpls_interface(text_content) -> dict[str, any]:
    ...
    try:
        ...
        return {"error": f"Error parsing show mpls interface: {str(e)}"}
def parse_show_mpls_lsp(text_content) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"error": f"Error parsing show mpls lsp: {str(e)}"}
def parse_show_mpls_lsp_p2mp(text_content) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"error": f"Error parsing show mpls lsp p2mp: {str(e)}"}
def parse_show_bgp_summary(text_content) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"error": f"Error parsing show bgp summary: {str(e)}"}
def parse_show_bgp_neighbor(text_content) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"error": f"Error parsing show bgp neighbor: {str(e)}"}
def parse_show_isis_adjacency_extensive(text_content) -> dict[str, any]:
    ...
    try:
        ...
        return {"error": f"Error parsing show isis adjacency extensive: {str(e)}"}
def parse_show_route_summary(text_content) -> dict[str, any]:
    ...
    try:
        ...
        return {"error": f"Error parsing show route summary: {str(e)}"}
def parse_show_rsvp_session_match_DN(text_content) -> Dict[str, Any]:
...
def parse_show_rsvp(text_content) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"error": f"Error parsing show rsvp: {str(e)}"}
